...
# %% auto 0
__all__ = ['def_device', 'extract_colors', 'scatter_plotly', 'compress_img', 'k_means', 'segment_k_means']
...
def k_means(points: torch.Tensor, k=5, eps=1e-4):
...
def segment_k_means(img: Image.Image, k=5, eps=1e-2):
    img = torch.tensor(np.array(img)/255, device=def_device)
